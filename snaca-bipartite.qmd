...
In all these examples, there are no direct ties between the nodes. For example, students who attend the same courses are not connected directly through some tie like friendship. Rather, they are connected through their shared course-taking. It is the *courses* that connect them.
...
In this example, we can define all of the pieces of the graph using our definition above:
...
-   How does the adjacency matrix of a bipartite graph differ from the adjacency matrix of a unipartite graph?
