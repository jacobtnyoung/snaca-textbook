...
As discussed in the chapter [Introduction to Social Network Analysis](https://jacobtnyoung.github.io/sna-textbook/sna-01-introduction.html), network science takes **relational structures** as the primary domain of interest. In so doing, research questions take the following forms:
