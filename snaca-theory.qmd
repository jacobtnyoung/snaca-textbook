...
As discussed in the chapter [Introduction to Social Network Analysis](snaca-introduction.html), network science takes **relational structures** as the primary domain of interest. In so doing, research questions take the following forms:
